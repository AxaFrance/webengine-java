...
class ReportHelperTest {
    ...
    void generateAllReport() throws URISyntaxException, IOException, WebEngineException {
        ...
        IReportHelper reportHelper = new ReportHelper(new JunitReportHelper(),new LoggerService());
        ...
        boolean resultCompareJunitReportFile = FileUtil.assertContent(FileUtil.getFileFromResource("report-test-result/junit-report.xml"), new File(reportMap.get(ReportPath.JUNIT_REPORT)));
        Assertions.assertTrue(resultCompareJunitReportFile);
