<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:we="http://www.axa.fr/WebEngine/2022">
    ...
    <xsl:template name="sub-header-template">
        ...
        <div class="badge-container">
            <span class="badge badge-secondary badge-action "><i class="fa fa-circle badge-action-gray" aria-hidden="true"></i> Ignored tests : <xsl:value-of select="we:TestSuiteReport/we:Failed"/></span>
        </div>
    </xsl:template>
