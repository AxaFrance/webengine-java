...
public class ApplicationDriveByExcel implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        //    java -jar drive-by-excel.jar -Dspring.profiles.active=properties-chrome "-workbook:file.xls" "-tc:firsttestcase[-dataNameColum:jdd-rec-auto;jdd-rec-moto] ; testcase2[-dataNameColum:jdd-rec-moto]" "-browser:Chrome" "-platform:Android"
