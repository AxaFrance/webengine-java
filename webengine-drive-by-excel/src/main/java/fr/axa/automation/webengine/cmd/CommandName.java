...
public enum CommandName {
    ...
    OPEN_KEEP_COOKIE(ImmutableMap.of(Locale.ENGLISH, "open and keep cookies", Locale.FRENCH, "ouvrir et conserver les cookies"),
            ImmutableMap.of(Locale.ENGLISH, "Open browser with the given url and keep cookies",
                    Locale.FRENCH, "Ouverture du navigateur avec l'url indiqué et conserver les cookies")),
