...
public enum CommandName {
    ...
    SAVE_DATA_AND_APPLY_OPERATOR(ImmutableMap.of(Locale.ENGLISH, "save data and apply operator", Locale.FRENCH, "enregistrer et appliquer un opérateur"),
            ImmutableMap.of(Locale.FRENCH, "Enregistre la valeur du contenu de l'élément indiqué et applique un opérateur",
                    Locale.ENGLISH, "Save the value of the element content and apply operator")),
