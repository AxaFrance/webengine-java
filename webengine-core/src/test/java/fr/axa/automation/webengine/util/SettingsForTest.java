...
public class SettingsForTest {
    ...
    public static Settings getSettings(){
        return  Settings.builder().platform(Platform.WINDOWS).browser(Browser.CHROMIUM_EDGE).outputDir(FileUtil.getPathInTargetDirectory(ReportConstant.REPORT_DIRECTORY_NAME.getValue())).build();
    }
